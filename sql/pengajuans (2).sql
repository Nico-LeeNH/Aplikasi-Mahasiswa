...
--
-- Host: localhost:3306
-- Generation Time: Jan 27, 2024 at 06:00 AM
...
CREATE TABLE `pengajuans` (
  ...
  `lembaga_pengajuan` varchar(225) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `nomor_surat_pengajuan` varchar(225) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `tgl_surat_pengajuan` varchar(225) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `file_pengantar_tujuan` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default_value',
